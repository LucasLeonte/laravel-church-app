                        ...
                        <tr>
                            ...
                            <td class="actions">
                                <div class="admin-actions">
                                    <a href="{{ route('resources.categories.edit', $category->id) }}" style="color: var(--primary); font-weight: 600; text-decoration: none;">
                                        Edit
                                    </a>
                                    <form action="{{ route('resources.categories.destroy', $category->id) }}" method="POST" style="display:inline; margin:0;" onsubmit="return confirm('Are you sure you want to delete this category?');">
                                        @csrf
                                        @method('DELETE')
